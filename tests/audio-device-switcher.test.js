...
const audio = require('../Alfred Workflows/user.workflow.87B8F8F3-59B7-4C3C-BD3E-79F164D1B0EE/audio.js');
...
assert.match(audio.listResult('input', run('', 1), null).items[0].title, /could not read/);
assert.match(audio.listResult('input', run('bad\n'), null).items[0].title, /unreadable/);
