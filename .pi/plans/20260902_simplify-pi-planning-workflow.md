...
- **Ledger:** {"status":"in_progress","note":"Wave 1 started; delegated state-model migration.","evidence":null}
...
### Part C — Propagate planning mode through status surfaces
- **Ledger:** {"status":"pending","note":null,"evidence":null}
...
### Part D — Rename trusted and child tool capabilities
- **Ledger:** {"status":"in_progress","note":"Wave 1 started; delegated trusted/child capability rename.","evidence":null}
...
### Part E — Document the two-mode contract
- **Ledger:** {"status":"pending","note":null,"evidence":null}
...
### Part F — Lock down conversational and restoration behavior
- **Ledger:** {"status":"pending","note":null,"evidence":null}
...
|---|---|---|---|---|---|
| 1 | worker-state | A | A | — | state model and workflow predicate migration |
| 1 | worker-capabilities | D | C | — | audited adapter and child capability identity |
| 2 | worker-presentation | B | B | A | candidate presentation and discussion orchestration |
| 3 | worker-status | C | C | A, B, D | planning gate, workflow event, status surfaces |
| 4 | worker-docs | E | C | B, C, D | planning workflow documentation and instruction text |
| 4 | worker-tests | F | D | A, B, C, D | workflow regression and integration test suites |
...
- ✓ Propagate planning mode through status surfaces
- ✓ Rename trusted and child tool capabilities
- ✓ Document the two-mode contract
